...
data class RatesResponse(
    ...
    @SerialName("LTL") val lTL: Double?,
    @SerialName("LVL") val lVL: Double?,
    ...
    @SerialName("STD") val sTD: Double?,
    @SerialName("SVC") val sVC: Double?,
